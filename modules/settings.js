...
export function registerSettings() {
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.concentrator.concentrationAttribute, {
		...
		default: BUTLER.KNOWN_GAME_SYSTEMS[game.system.id]
			? BUTLER.KNOWN_GAME_SYSTEMS[game.system.id].concentrationAttribute
			: BUTLER.KNOWN_GAME_SYSTEMS.other.concentrationAttribute,
		scope: "world",
		type: String,
		config: false,
		onChange: (s) => {},
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.concentrator.healthAttribute, {
		...
		default: BUTLER.KNOWN_GAME_SYSTEMS[game.system.id]
			? BUTLER.KNOWN_GAME_SYSTEMS[game.system.id].healthAttribute
			: BUTLER.KNOWN_GAME_SYSTEMS.other.healthAttribute,
		scope: "world",
		type: String,
		config: false,
		onChange: (s) => {},
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.concentrator.notifyConcentration, {
		...
		default: Sidekick.getKeyByValue(
			BUTLER.DEFAULT_CONFIG.concentrator.notifyConcentration,
			BUTLER.DEFAULT_CONFIG.concentrator.notifyConcentration.none
		),
		scope: "world",
		type: String,
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.concentrator.notifyConcentrationCheck, {
		...
		default: Sidekick.getKeyByValue(
			BUTLER.DEFAULT_CONFIG.concentrator.notifyConcentrationCheck,
			BUTLER.DEFAULT_CONFIG.concentrator.notifyConcentrationCheck.none
		),
		scope: "world",
		type: String,
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.concentrator.notifyDouble, {
		...
		default: Sidekick.getKeyByValue(
			BUTLER.DEFAULT_CONFIG.concentrator.notifyDouble,
			BUTLER.DEFAULT_CONFIG.concentrator.notifyDouble.none
		),
		scope: "world",
		type: String,
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.concentrator.notifyEndConcentration, {
		...
		default: Sidekick.getKeyByValue(
			BUTLER.DEFAULT_CONFIG.concentrator.notifyEndConcentration,
			BUTLER.DEFAULT_CONFIG.concentrator.notifyEndConcentration.none
		),
		scope: "world",
		type: String,
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.panSelect.panGM, {
		...
		default: Sidekick.getKeyByValue(
			BUTLER.DEFAULT_CONFIG.panSelect.panGM,
			BUTLER.DEFAULT_CONFIG.panSelect.panGM.none
		),
		scope: "world",
		type: String,
	...
	Sidekick.registerSetting(BUTLER.SETTING_KEYS.panSelect.panPlayers, {
		...
		default: Sidekick.getKeyByValue(
			BUTLER.DEFAULT_CONFIG.panSelect.panPlayers,
			BUTLER.DEFAULT_CONFIG.panSelect.panPlayers.none
		),
		scope: "world",
		type: String,
